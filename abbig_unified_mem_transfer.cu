...
void loadArray(const std::string &filename, int* &devkys, int &size) {
    ...
    cudaMallocManaged(&devkys, size * sizeof(int));

    // Read actual data into devkys
    inFile.read(reinterpret_cast<char*>(devkys), size * sizeof(int)); 
    inFile.close();
}
...
void storeDataDevice(string str){
    ...
    loadArray("abbig_data_files/lev1_keys_"+str+".dat", d_l1keys, l1sz);
    loadArray("abbig_data_files/lev2_keys_"+str+".dat", d_l2keys, l2sz);
    loadArray("abbig_data_files/lev3_keys_"+str+".dat", d_l3keys, l3sz);
    loadArray("abbig_data_files/leaf_keys_"+str+".dat", d_lfkeys, lfsz);
    loadArray("abbig_data_files/lev1_indx_"+str+".dat", d_l1chid, l1sz);
    loadArray("abbig_data_files/lev2_indx_"+str+".dat", d_l2chid, l2sz);
    loadArray("abbig_data_files/lev3_indx_"+str+".dat", d_l3chid, l3sz);
